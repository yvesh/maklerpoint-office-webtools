 ...
 */
    ...
    $currentfile = "http://www.maklerpoint.de/appcon/mp-office/update/files/mp_office-021110-b231.zip";
    $filesize = "55,03 MB";
   ...
   $sql = "INSERT INTO updatecheck (version, build, serialhash, os, osname, osarch, osversion, vmvendor," .
...
//           echo $sql;
   ...
   if($version != $currentversion) {
       ...
       echo "changelog=http://www.maklerpoint.de/appcon/mp-office/update/changelog-current.txt\n";
