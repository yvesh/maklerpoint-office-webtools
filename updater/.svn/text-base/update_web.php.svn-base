 ...
 */
     ...
     * Configuration
     */
    $currentversion = "0.6.1.05";
    $currentfile = "http://www.maklerpoint.de/appcon/mp-office-web/update/files/mp_office_web-090111-b21.zip";
    $filesize = "43,03 MB";
   ...
   $sql = "INSERT INTO updatecheck_web (version, build, serialhash, os, osname, osarch, osversion, vmvendor," .
...
//           echo $sql;
   ...
   if($version != $currentversion) {
       ...
       echo "changelog=http://www.maklerpoint.de/appcon/mp-office-web/update/changelog-current.txt\n";
